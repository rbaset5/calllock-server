...
// Triage Engine Types (Phase 2)
export type CallerType = "residential" | "commercial" | "vendor" | "recruiting" | "unknown";

export type PrimaryIntent = "new_lead" | "active_job_issue" | "booking_request" | "admin_billing" | "solicitation";

export type BookingStatus = "confirmed" | "attempted_failed" | "not_requested";
...
/**
 * Payload sent by Retell AI when a function tool is called
 */
export interface RetellFunctionWebhook {
...
export interface CustomAnalysisData {
  ...
  // New fields for V3 System Prompt
  caller_type?: string;
